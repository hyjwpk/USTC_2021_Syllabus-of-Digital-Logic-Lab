...
HD_PWD='C:/Users/wangc/lab7/lab7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log practice3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source practice3.tcl
