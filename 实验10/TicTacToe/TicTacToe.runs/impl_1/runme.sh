...
HD_PWD='C:/Users/wangc/TicTacToe/TicTacToe.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TicTacToe.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TicTacToe.tcl -notrace
