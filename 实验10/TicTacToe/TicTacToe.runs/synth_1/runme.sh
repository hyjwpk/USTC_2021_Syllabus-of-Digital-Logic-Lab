...
HD_PWD='C:/Users/wangc/TicTacToe/TicTacToe.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TicTacToe.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TicTacToe.tcl
