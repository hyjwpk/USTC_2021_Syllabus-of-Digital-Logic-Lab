...
# set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { rx_data[1] }];
...
# set_property -dict { PACKAGE_PIN D17   IOSTANDARD LVCMOS33 } [get_ports { rx_data[4] }];
# set_property -dict { PACKAGE_PIN E17   IOSTANDARD LVCMOS33 } [get_ports { rx_data[5] }];
# set_property -dict { PACKAGE_PIN F18   IOSTANDARD LVCMOS33 } [get_ports { rx_data[6] }];
# set_property -dict { PACKAGE_PIN G18   IOSTANDARD LVCMOS33 } [get_ports { rx_data[7] }];
